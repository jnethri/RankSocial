...
<div class="pp-dual-button-content clearfix">
	<div class="pp-dual-button-inner">
		<div class="pp-dual-button-1 pp-dual-button pp-button-effect-<?php echo $settings->button_1_effect; ?>">
			<a href="<?php echo esc_url( do_shortcode( $settings->button_1_link ) ); ?>" class="pp-button <?php echo $settings->button_1_css_class; ?>" role="button"<?php echo $target_1; ?><?php echo $nofollow_1; ?><?php echo $attr1; ?> onclick="">
		...
		<div class="pp-dual-button-2 pp-dual-button pp-button-effect-<?php echo $settings->button_2_effect; ?>">
			<a href="<?php echo esc_url( do_shortcode( $settings->button_2_link ) ); ?>" class="pp-button <?php echo $settings->button_2_css_class; ?>" role="button"<?php echo $target_2; ?><?php echo $nofollow_2; ?><?php echo $attr1; ?> onclick="">
