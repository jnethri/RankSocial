...
.fl-node-<?php echo $id; ?> .pp-line-separator-inner.pp-line-only .pp-line-separator {
	<?php if($settings->line_color) { ?>border-bottom-color: <?php echo pp_get_color_value( $settings->line_color ); ?>;<?php } ?>
...
.fl-node-<?php echo $id; ?> .pp-line-separator-inner.pp-icon-image .pp-icon-wrap span.pp-icon {
	<?php if($settings->font_icon_bg_color) { ?>background: <?php echo pp_get_color_value( $settings->font_icon_bg_color ); ?>;<?php } ?>
	<?php if($settings->font_icon_color) { ?>color: <?php echo pp_get_color_value( $settings->font_icon_color ); ?>;<?php } ?>
